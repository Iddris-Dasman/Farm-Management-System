...
function fetch_data()
{
    ...
    $sql = "SELECT * FROM livestock ORDER BY id ASC";
...
if (isset($_POST["print_crop"])) {
    ...
    $content = '';
    $content .= '  
      <h4 align="center">Livestock</h4><br /> 
      <table border="1" cellspacing="0" cellpadding="3">  
           <tr>  
            ...
            <th width="25%">Quantity</th>  
                ...
                <th width="25%">Death/Date Sold</th>  
           </tr>  
      ';
    $content .= fetch_data();
    $content .= '</table>';
        ...
        <a href="./report.php" class='btn btn-warning ml-10'></i> Report</a>
            ...
            <table class="table table-striped table-bordered table-hove">
                ...
                <tr>
                    ...
                    <th width="15%">Death/Date Sold</th>
                </tr>
                <?php
                echo fetch_data();
                ?>
