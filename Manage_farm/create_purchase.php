  ...
  if(isset($_POST['createpurchase'])) 
    {
        ...
        $query= "INSERT INTO purchases(date, item, ucost, quantity, tcost) VALUES('{$date}','{$item}','{$ucost}', '{$quantity}', '{$tcost}')";
...
<h1 class="text-center">Add Purchases  </h1>
  <div class="container">
    <form action="" method="post">
      ...
      <div class="form-group">
        <input type="submit"  name="createpurchase" class="btn btn-secondary mt-2" value="submit">
      </div>
      </div>
    </form> 
  </div>
